...
class Property(models.Model):
    ...
    property_type = models.IntegerField(choices = PropertyType.choices, default=1)
    detailed_type = models.IntegerField(choices = DetailedType.choices, default=1)
    size = models.IntegerField()
    description = models.TextField()
    maintenance_cost = models.IntegerField()
    status = models.IntegerField(choices = StatusType.choices, default=1) 
